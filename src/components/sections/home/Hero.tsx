...
const DEFAULT_HERO = {
  badge: 'Beta: Live Testing Platform',
  title: 'Test your ideas instantly with',
  titleHighlight: 'Zero-friction validation',
  description:
    'Launch test websites in seconds, gather real user feedback, and iterate faster than ever. Perfect for developers, designers, and product teams.',
  features: [
  ...
  imageAlt: 'Analytics dashboard showing test results',
